...
enum class AdminTabItem(@DrawableRes val iconRes: Int, @StringRes val label: Int) {
    Home(R.drawable.ic_home, R.string.home),
    MyHotels(R.drawable.ic_my_hotel, R.string.my_hotels),
...
fun AdminBottomBar(
    ...
    val tabs = AdminTabItem.entries.toTypedArray()
