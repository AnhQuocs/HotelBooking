        ...
        when (booking.stayStatus) {
            ...
            StayStatus.CHECK_IN -> {
                ...
                Column(verticalArrangement = Arrangement.spacedBy(AppSpacing.XS)) {
                    ...
                    AppButton(
                        onClick = { onCheckOut(StayStatus.CHECK_OUT) },
                        modifier = Modifier.fillMaxWidth(),
...
@Composable
fun BookingProcessingOverlay(show: Boolean, isCancelling: Boolean) {
    if (!show) return
    ...
    Box(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Text(
                color = PrimaryBlue,
                text = stringResource(
                    if (isCancelling) R.string.loading_cancelling
                    else R.string.loading_processing
                )
            )
        }
    }
